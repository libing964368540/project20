...
layui.define("jquery", function(e) {
	...
	r.prototype.init = function(e) {
		...
		layui.each(n, function(a, n) {
			var l_b=n.children && n.children.length ==0;
			var l = n.children && n.children.length > 0,
				...
				s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function() {
					...
					return '<a href="' + (n.href || "javascript:;") + '" ' + (r.target && n.href ? 'target="' + r.target + '"' : "") + ">" + ('<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ? n.spread ? t.branch[1] : t.branch[0] : l_b?t.branch[0]:t.leaf) + "</i>") + ("<cite>" + (n.name || "未命名") + "</cite></a>")
				}(), "</li>"].join(""));
